...
El administrador o supervisor registra puntos de control.
Cada punto tiene nombre, ubicacion, descripcion y codigo QR.
Se crean rutas con los puntos que debe visitar el guardia.
Desde Configuracion > Usuarios se puede generar el QR Guardia.
El administrador puede consultar historial, cumplimiento, avance y detalle de recorridos.
Flujo del guardia:
El guardia entra a Mi rondin desde su sidebar.
Antes de iniciar, escanea su tarjeta QR Guardia.
Selecciona la ruta asignada.
Inicia el rondin.
Escanea los QR de los puntos visitados.
Puede reportar novedades durante el recorrido.
Cierra el rondin al finalizar.
El rondinero guarda:
...
La version visible en el sidebar.
